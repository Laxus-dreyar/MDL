...
if __name__ == "__main__":
    ...
    for i in range(20):
        ...
        while True:  #This while loop ensures that there are no duplicate individuals in the population
        ...
        """After every iteration i submited the top 20 vectors acc to fitness and valerror in the last few days just to be safe""" 
        population = sorted(population,key=lambda x: x.fitness)
        for i in range(20):
    ...
    """Use this To run for 3 iterations population size 10"""
    # population = []
    # population_size = 10
